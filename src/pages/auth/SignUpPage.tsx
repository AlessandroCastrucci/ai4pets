    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-sky-50 via-blue-50 to-slate-100 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800">
      ...
      <div className="flex-1 flex flex-col justify-center px-5 py-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Start managing your pets' health for free</p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-card-md p-6 space-y-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="text-xs font-semibold text-slate-600 dark:text-slate-300 block mb-1.5">Full name</label>
              <input
                type="text"
                value={name}
            ...
            <div>
              <label className="text-xs font-semibold text-slate-600 dark:text-slate-300 block mb-1.5">Password</label>
