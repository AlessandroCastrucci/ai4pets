...
export const PARASITE_PROTECTION_PLANS: ParasiteProtectionPlan[] = [
  {
    id: 'pp-luna',
    petId: 'luna',
    fleaTreatment: {
    ...
    tickTreatment: {
      ...
      reminderEnabled: true,
      reminderTime: '08:00',
      notes: 'Chewable tablet with food',
    },
    wormTreatment: {
  ...
  },
  {
    ...
    tickTreatment: {
      ...
      reminderEnabled: true,
      reminderTime: '08:00',
      notes: 'Combined flea & tick product',
    },
    wormTreatment: {
  ...
  },
  {
    ...
    fleaTreatment: {
      ...
      reminderEnabled: true,
      reminderTime: '08:00',
      notes: 'Spot-on, back of neck',
    },
    tickTreatment: {
      productName: 'Seresto Collar',
      lastDate: '2026-01-10',
      nextDate: '2026-07-10',
      frequency: 'Every 6 months',
      reminderEnabled: true,
      reminderTime: '09:00',
      notes: 'Replace collar every 6 months',
    },
    wormTreatment: {
      productName: 'Milbemax Cat',
      lastDate: '2026-05-01',
      nextDate: '2026-08-01',
      frequency: 'Every 3 months',
      reminderEnabled: true,
